...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(providers: [
      BlocProvider(create: (context) => LoginBloc(LoginRepositoryImpl())),
      BlocProvider(create: (context) => RegisterBloc(RegistrationRepositoryImpl())),
      BlocProvider(create: (context) => HomeBloc(serviceLocator.get<HomeRepositoryImpl>()))
